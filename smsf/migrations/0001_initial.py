# Generated by Django 2.1.7 on 2019-03-24 00:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='smsfmember',
            name='place_of_birth',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='place_of_birth', to='smsf.Address'),
        ),
        migrations.AddField(
            model_name='smsfmember',
            name='place_of_residence',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='place_of_residence', to='smsf.Address'),
        ),
        migrations.AddField(
            model_name='smsfmember',
            name='smsfund',
